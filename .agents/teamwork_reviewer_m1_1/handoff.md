...
- **Code Inspection Results**:
  ...
  - `src/utils/rbac.ts`: Corrected `DESIGNATION_RANKS` map to rank office bearers in order: `अध्यक्ष` (1), `कार्याध्यक्ष` (2), `उपाध्यक्ष` (3), `सचिव` (4), `खजिनदार` (5), `उपखजिनदार` (6), `सभाсад` (7).
